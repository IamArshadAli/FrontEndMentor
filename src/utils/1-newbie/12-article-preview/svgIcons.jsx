const ShareIcon = () => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="15" height="13" className="cursor-pointer">
      <path
        fill="#fff"
...
const FacebookIcon = () => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" className="cursor-pointer">
      <path
        fill="#fff"
...
const TwitterIcon = () => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="17" className="cursor-pointer">
      <path
        fill="#FFF"
...
export { ShareIcon, FacebookIcon, TwitterIcon, PinterestIcon };
